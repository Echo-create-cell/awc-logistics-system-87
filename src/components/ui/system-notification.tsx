...
const systemNotificationVariants = cva(
  "relative w-full rounded-lg border p-4 shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out bg-popover text-popover-foreground",
  {
    variants: {
      ...
      position: {
        "top-right": "fixed top-4 right-4 z-[99997] max-w-sm",
        "top-left": "fixed top-4 left-4 z-[99997] max-w-sm",
        "bottom-right": "fixed bottom-4 right-4 z-[99997] max-w-sm",
        "bottom-left": "fixed bottom-4 left-4 z-[99997] max-w-sm",
        "top-center": "fixed top-4 left-1/2 transform -translate-x-1/2 z-[99997] max-w-sm",
