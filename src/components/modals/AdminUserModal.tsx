  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto bg-background">
              ...
              <div className="flex items-center gap-2">
                ...
                {isEditing && form.status && (
                  <Badge variant={form.status === 'active' ? "default" : "secondary"} 
                         className={form.status === 'active' ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}>
                    {form.status}
                  </Badge>
                )}
              </div>
        ...
        <div className="py-6 space-y-6">
          ...
          <Card className="border-border">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="role" className="text-sm font-medium text-foreground">User Role</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="status" className="text-sm font-medium text-foreground">Account Status</Label>
          ...
          <Card className="border-border">
            <CardContent className="p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-medium text-foreground">Credentials Management</h3>
              </div>
              ...
              {!isEditing ? (
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="bg-background border-border focus:border-blue-500 focus:ring-blue-500 pr-10"
                        />
                        <Button
                          type="button"
                          variant="ghost"
                  ...
                  <Button
                    ...
                    className="w-full bg-background border-border hover:bg-gray-50"
                  >
                  ...
                  {userCredentials && (
                    <div className="p-4 bg-gray-50 rounded-lg border border-border">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-medium text-foreground text-sm">Current Credentials</h4>
                        <Button
                          variant="outline"
                          size="sm"
        ...
        <DialogFooter className="pt-6 border-t border-border bg-gray-50 -mx-6 -mb-6 px-6 py-4 rounded-b-lg">
